...
Spark obscures a huge amount of the complexity of working with a cluster of computers for data analysis. Even when the code can look very familiar, it's critical to understand how some of the processing and calculations are happening under the hood. The differences in the distributed framework have important implications for what analyses are possible and what code is efficient. This Chapter discussing the intuitive and implications of parallel processing, while the next chapters explore sorting and advanced statistical analyses.


## What Makes Parallel Processing Different?
